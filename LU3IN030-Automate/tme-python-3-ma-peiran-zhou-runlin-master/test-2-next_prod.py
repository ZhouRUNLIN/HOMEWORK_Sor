...
print("\n\n----------------------------------------------\n\n")
print("Test 1 : Fonction next_prod")
print("---------------------------")

assert eq_set(eq_atom, next_prod(g1_t,g1_r,eq_atom,prod0(g1_t,g1_r)), ['A3', 'A6', 'A9']), "Erreur dans la fonction next_prod : exemple 1 - 1 etape"
...
print("Test 2 : Fonction next_prod")
print("---------------------------")

assert eq_set(eq_atom, next_prod(exo11_a_t,exo11_a_r,eq_atom,prod0(exo11_a_t,exo11_a_r)), ['S', 'A', 'B']), "Erreur dans la fonction next_prod : exo11a"
...
print("Test 3 : Fonction next_prod")
print("---------------------------")

assert eq_set(eq_atom, next_prod(exo11_b_t,exo11_b_r,eq_atom,prod0(exo11_b_t,exo11_b_r)), ['S', 'A', 'B']), "Erreur dans la fonction next_prod : exo11_b - 1 etape"
...
print("Test 4 : Fonction next_prod")
print("-----------------------")


assert eq_set(eq_atom, next_prod(exo12_t,exo12_r,eq_atom,prod0(exo12_t,exo12_r)), ['S', 'A', 'B', 'C']), "Erreur dans la fonction next_prod : exo12 - 1 etape"
...
print("Test 5 : Fonction next_prod")
print("-----------------------")


assert eq_set(eq_atom, next_prod(exo13_t,exo13_r,eq_atom,prod0(exo13_t,exo13_r)), ['S0', 'S3', 'S4', 'S5']), "Erreur dans la fonction next_prod : exo13 - 1 etape"
...
print("Test 6 : Fonction next_prod")
print("-----------------------")


assert eq_set(eq_atom, next_prod(g_red_t,g_red_r,eq_atom,prod0(g_red_t,g_red_r)), ['S', 'T', 'V']), "Erreur dans la fonction next_prod : exo13 - 1 etape"