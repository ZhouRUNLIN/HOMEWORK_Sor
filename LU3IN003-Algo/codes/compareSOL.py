...
#Tracer le graphique
x=np.arange(20,350)
l1=plt.plot(tailleMot, cpuTemps1,'r--',label='sol_1')
l2=plt.plot(tailleMot, cpuTemps2,'g--',label='sol_2')
plt.plot(tailleMot, cpuTemps1,'ro-', tailleMot, cpuTemps2,'g+-')
plt.title('comparation entre sol_1 et sol_2')
plt.xlabel('|x|')
plt.ylabel('CPU time')
plt.legend()
plt.show()