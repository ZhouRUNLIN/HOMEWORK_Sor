//dans le ficher Entree.java
public class Entree extends PlatFroid implements Estimer{
	private int val;
	private double prix;

	public Entree(String nom, double prix, int val){
		super(nom);
		this.prix = prix;
		this.val = val;
	}
	...
	public Plat clone(){
		return new Entree(super.getNom(),prix, val);
	}
